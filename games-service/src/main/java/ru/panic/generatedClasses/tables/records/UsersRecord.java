...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> {
    ...
    /**
     * Setter for <code>public.users.demo_balance</code>.
     */
    public void setDemoBalance(Double value) {
        set(2, value);
    }

    /**
     * Getter for <code>public.users.demo_balance</code>.
     */
     ...
     */
    public UsersRecord(Long id, Double btcBalance, Double demoBalance, Double ethBalance, String ipAddress, Boolean isAccountNonLocked, Boolean isMultiAccount, Double progress, Short rank, Double ltcBalance, Double maticBalance, Double tethererc20balance, Double tonBalance, Double trxBalance, Double xrpBalance, String password, Long timestamp, String city, String country, Integer postcode, String street, String birthday, String firstname, Short gender, String lastname, String username) {
        super(Users.USERS);
